function clearAll() {
  ...
  function showRiddle() {
    ...
    const answerElm = document.createElement('p');
    answerElm.textContent = "The answer is - " + answer;
    answerElm.setAttribute('id', 'riddle-answer');
    answerElm.hidden = true;
    
    clearAll();
    
    container.appendChild(questionElm);
    container.appendChild(answerElm);
  }
